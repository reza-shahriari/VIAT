...
import numpy as np
try:
    from viat.evaluation.evaluators.pascal_voc_evaluator import (calculate_ap_11_point_interp,
                                                                 calculate_ap_every_point)
    from viat.evaluation.utils.enumerators import MethodAveragePrecision
    from viat.evaluation.utils.read_files import File
except ImportError:
    from .pascal_voc_evaluator import (calculate_ap_11_point_interp,
                                       calculate_ap_every_point)
